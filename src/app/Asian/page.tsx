...
const page = () => {
  return (
    <div>
      <div className="text-white -translate-y-10 sm:px-5 px-1 ">
        <h2 className="sm:text-[30px] text-[23px] font-semibold py-4 ">Popular Asian Drama</h2>
        <div className=" px-2 grid grid-cols-3 md:grid-cols-6 gap-5 ">
          <div className="">
            ...
            <div className="border border-t-0 border-blue-700 rounded-b-lg px-2 leading-8 ">
              <p className="sm:text-[16px] text-[13px] truncate">No way Home</p>
